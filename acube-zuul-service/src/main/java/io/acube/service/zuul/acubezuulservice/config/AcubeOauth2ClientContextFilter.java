...
* @since 30.01.2018
* 
* Class with Oauth2 authentication configuration
*/
package io.acube.service.zuul.acubezuulservice.config;
...
public class AcubeOauth2ClientContextFilter  extends OAuth2ClientContextFilter {
